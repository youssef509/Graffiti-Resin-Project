...
use App\Models\HomeAboutEn;

class HomeAboutControllerEN extends Controller
{
    public function index() {
        $HomeAbout = HomeAboutEN::first();
        return view('backend.home.aboutEn', ['homeAbout' => $HomeAbout]);
    }
