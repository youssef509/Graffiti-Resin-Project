...
use App\Models\WhyUsAr;

class WhyUsControllerAR extends Controller
{
    public function index() {
        $whyusFromDB = WhyUsAr::first();
        return view('backend.Home.whyus', ['whyus' => $whyusFromDB]);
    }
    public function store() {
        ...
        return to_route('admin.whyus-Ar')->with('success-create', 'تم اضافة العنصر بنجاح');
    }

    public function update(WhyUsAr $whyus) {
        request()->validate([
            'title1' => ['required'],
            'title2' => ['required'],
            'text1' => ['required'],
        ...
        return to_route('admin.whyus-Ar')->with('success-update', 'تم تحديث العنصر بنجاح');
    }
}
