                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="datatable table-bordered  mdl-data-table dataTable" data-url="{{ route('admin.ImplementationofWorks-data') }}" cellspacing="0" width="100%" role="grid" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>الاسم</th>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">طلبات تنفيذ مشاريع</h4>
                            ...
                            <div class="tab-content p-3 text">
                                <div class="tab-pane active" id="arabic-1" role="tabpanel">
                                    <form method="POST" action="{{route('ImplementationofWorks-add')}}"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="project_type" class="form-control" type="text">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-text-input" class="form-label">نوع المبنى</label>
                                                    <input name="building_type" class="form-control" type="text">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="gaps" class="form-control" type="text">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="floor_statue" class="form-control" type="text">
                                                </div>
                                                <div class="mb-3">
...
@section('js')
    ...
    <!-- Link to table.js -->
    <script src="{{ asset('backend/assets/js/ImplementationofWorks-table.js') }}"></script>
@endsection
