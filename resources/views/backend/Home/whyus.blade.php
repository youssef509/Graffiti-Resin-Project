                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" href="{{route('admin.whyus-En')}}" role="tab">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="arabic-1" role="tabpanel">
                                        <form method="POST" action="{{ $whyus ? route('admin.whyus-update-Ar', $whyus->id) : route('admin.whyus-store-Ar') }}"  enctype="multipart/form-data">
                                            @csrf
                                            @if($whyus)
                                                @method('PUT')
                                            @endif
