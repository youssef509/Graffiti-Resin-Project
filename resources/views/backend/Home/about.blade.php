                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" href="{{route('admin.homeabout-En')}}" role="tab">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="arabic-1" role="tabpanel">
                                        <form method="POST" action="{{ $homeAbout ? route('admin.homeabout-updateAr', $homeAbout->id) : route('admin.homeabout-storeAr') }}"  enctype="multipart/form-data">
                                            @csrf
                                            @if($homeAbout)
                                                @method('PUT')
                                            @endif
