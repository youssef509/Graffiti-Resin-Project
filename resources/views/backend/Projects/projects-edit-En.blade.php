                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="arabic-1" role="tabpanel">
                                        <form method="POST" action="{{route('admin.projects-update-En',$project->id )}}"  enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        @foreach($ProjectImages as $ProjectImage)
                                            <div class="col-4">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img class="card-img-top img-fluid" src="{{ $ProjectImage->image_url }}" alt="Card image cap"><br><br>
