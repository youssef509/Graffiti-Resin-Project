                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" href="{{route('admin.projects-En')}}" role="tab">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="arabic-1" role="tabpanel">
                                        <form method="POST" action="{{route('admin.projects-store-Ar')}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                            ...
                                            <div class="col-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form method="POST" action="{{route('admin.projects-destroy-Ar', $project->id)}}" class="delete-form" style="display: inline">
                                                            @csrf
                                                            @method('DELETE')
