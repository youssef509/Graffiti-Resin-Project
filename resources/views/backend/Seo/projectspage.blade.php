                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> SEO | المشاريع</h4>
                            </div>
                            <div class="card-body p-4">
                                ...
                                @endif
                                <form method="POST" action="{{ $Data ? route('seo-projectspage-update', $Data->id) : route('seo-projectspage-store') }}" enctype="multipart/form-data">
                                    @csrf
                                    @if($Data)
                                        @method('PUT')
                                    @endif
