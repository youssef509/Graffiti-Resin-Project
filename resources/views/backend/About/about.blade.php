                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" href="{{route('admin.about-us-En')}}" role="tab">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="arabic-1" role="tabpanel">
                                        <form method="POST" action="{{ $Aboutus ? route('admin.about-us-update-Ar', $Aboutus->id) : route('admin.about-us-store-Ar') }}"  enctype="multipart/form-data">
                                            @csrf
                                            @if($Aboutus)
                                                @method('PUT')
                                            @endif
