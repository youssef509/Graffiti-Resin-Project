                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" href="{{route('admin.blogs-Ar')}}" role="tab">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="english-1" role="tabpanel">
                                        <form method="POST" action="{{route('admin.blogs-store-En')}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                            ...
                                            <div class="col-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a href="{{route('admin.blogs-edit-En', $blog->id)}}" class="btn btn-success waves-effect waves-light">تعديل</a>
                                                        <form method="POST" action="{{route('admin.blogs-destroy-En', $blog->id)}}" class="delete-form" style="display: inline">
                                                            @csrf
                                                            @method('DELETE')
