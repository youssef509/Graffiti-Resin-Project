...
@endsection
@section('title', __('messages.Trainingandsupervision'))
    ...
    <div class="page-title-area ptb-100">
        <div class="container">
            <div class="page-title-content">
                <h1>@lang('messages.Trainingandsupervision')</h1>
                <ul>
                    <li class="item"><a href="{{route('home')}}">@lang('messages.Home')</a></li>
                    <li class="item"><a href="{{route('contact')}}"><i class="flaticon-play-button"></i>@lang('messages.Trainingandsupervision')</a></li>
                </ul>
            </div>
        </div>
        <div class="bg-image">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    <div class="contact-form">
                        <div class="content">
                            <h3>@lang('messages.Trainingandsupervision')</h3>
                        </div>
                        <section class="quote-section pt-100 pb-70">
                            <div class="container">
                                <div class="row align-items-end">
                                    <div class="col-lg-12">
                                        <div class="contact-form">
                                            <form  method="post" action="{{route('trainingsupervision-send')}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="age" class="form-control"  data-error="Please enter your age" placeholder="@lang('messages.age')" />
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="current_job" class="form-control" required data-error="Please enter your current_job" placeholder="@lang('messages.Currentjob')" />
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea name="reason"  class="form-control" cols="30" rows="6" required data-error="Please enter your reason" placeholder="@lang('messages.reason')"></textarea>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                    <div class="col-lg-12">
